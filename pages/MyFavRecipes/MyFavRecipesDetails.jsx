      ...
      {detailsDownload && (
        <View style={[styles.container]}>
          ...
          <AntDesign
            ...
            color="#FA4A0C"
            onPress={() => {
              navigation.navigate("MyFavRecipes");
            }}
            style={{ margin: 15 }}
          />
          ...
          <View style={[styles.general]}>
            {detailsDownload?.imagen ? (
              <Image
                style={[styles.img]}
                source={{ uri: detailsDownload?.imagen }}
              />
            ) : (
              <Text></Text>
            )}
          ...
          <View style={[styles.general, styles.row]}>
            ...
            <Text style={styles.cantPersonas}>
                  ...
                  {detailsDownload?.cantidadPersonas}{" "}
                  {detailsDownload?.cantidadPersonas > 1 ? "personas" : "persona"}
          ...
          <View style={[styles.general]}>
            <Text style={styles.name}>{detailsDownload?.nombre}</Text>
          </View>

          <View style={[styles.general, styles.row]}>
            <Text style={styles.tipoReceta}>
              {" "}
              Tipo de receta: {detailsDownload?.tipo}
            </Text>
          </View>
          ...
          <View style={[styles.generalSubTitle]}>
            ...
            {detailsDownload?.utilizados?.map((ingrediente, index) => (
              <Text key={index} style={styles.subTitleDes}>
                {ingrediente?.ingrediente} {" "}

               
                  
                    {parseInt(detailsDownload?.cantidad) }
...
export default DetailsCardFavorito;
